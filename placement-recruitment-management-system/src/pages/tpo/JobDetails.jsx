    ...
    return (
      <div className="container-fluid p-0">
        <div className="card border-0 bg-white shadow-sm p-5 text-center my-4" style={{ borderRadius: '16px' }}>
          ...
          <p className="text-muted mb-4">The requested job opening details could not be found or loaded.</p>
          <div>
            <button onClick={() => navigate('/tpo/jobs')} className="btn btn-primary px-4 py-2 fw-semibold rounded-3">
